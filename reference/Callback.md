...
[`call_back()`](https://mlr3misc.mlr-org.com/reference/call_back.md). A
[Context](https://mlr3misc.mlr-org.com/reference/Context.md) defines
which information can be accessed from the callback.
