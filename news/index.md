...
- perf: [`rcbind()`](https://mlr3misc.mlr-org.com/reference/rcbind.md)
  uses `%in%` instead of
...
- perf: [`unnest()`](https://mlr3misc.mlr-org.com/reference/unnest.md)
...
- fix:
  [`encapsulate()`](https://mlr3misc.mlr-org.com/reference/encapsulate.md)
  with `"evaluate"` now respects `.seed` and `.opts`.
- refactor:
  [`encapsulate()`](https://mlr3misc.mlr-org.com/reference/encapsulate.md)
  with `"evaluate"` no longer stores output, consistent with other
  encapsulation methods.
- refactor: Messages in
  [`encapsulate()`](https://mlr3misc.mlr-org.com/reference/encapsulate.md)
  logs are now stored as `condition` objects instead of `character`.
...
- fix: [`unnest()`](https://mlr3misc.mlr-org.com/reference/unnest.md)
  now works with vector-valued elements.
- feat: Add
  [`warn_deprecated()`](https://mlr3misc.mlr-org.com/reference/warn_deprecated.md).
- BREAKING CHANGE: Remove `"msg"` column from encapsulate logs.
- fix:
  [`discard()`](https://mlr3misc.mlr-org.com/reference/compat-map.md) no
  longer removes attributes.
- perf: Use
...
- feat: Functions
  [`warningf()`](https://mlr3misc.mlr-org.com/reference/printf.md) and
  [`stopf()`](https://mlr3misc.mlr-org.com/reference/printf.md) now have
  a `class` argument and also add the additional class `mlr3warning` and
  `mlr3error`, respectively. The condition object now also includes the
  call.
...
- fix: [`crate()`](https://mlr3misc.mlr-org.com/reference/crate.md) is
  using the correct ‘topenv’ environment now.
...
- Added argument `.compile` to function
  [`crate()`](https://mlr3misc.mlr-org.com/reference/crate.md) because R
  disables byte-code compilation of functions when changing their
...
- Updated default environment for
  [`crate()`](https://mlr3misc.mlr-org.com/reference/crate.md) to
...
- Added initial support for a callback mechanism, see
  [`as_callback()`](https://mlr3misc.mlr-org.com/reference/as_callback.md).
- Added helper
  [`catn()`](https://mlr3misc.mlr-org.com/reference/catn.md).
- Added helper
...
- Added helper
  [`get_private()`](https://mlr3misc.mlr-org.com/reference/get_private.md).
- Added helper
  [`map_br()`](https://mlr3misc.mlr-org.com/reference/compat-map.md) and
...
- Added helpers
  ...
  [`iwalk()`](https://mlr3misc.mlr-org.com/reference/compat-map.md) and
...
- Added assertions in
  [`pmap()`](https://mlr3misc.mlr-org.com/reference/compat-map.md) to
  avoid a segfault
...
- Added [`compose()`](https://mlr3misc.mlr-org.com/reference/compose.md)
...
- Fixed an issue with
  [`rcbind()`](https://mlr3misc.mlr-org.com/reference/rcbind.md) for
...
- Fixed broken [`on.exit()`](https://rdrr.io/r/base/on.exit.html) in
  [`invoke()`](https://mlr3misc.mlr-org.com/reference/invoke.md) if both
  a seed and a list of options were provided.
...
- Added argument `wrap` to
  ...
  [`warningf()`](https://mlr3misc.mlr-org.com/reference/printf.md) and
  [`stopf()`](https://mlr3misc.mlr-org.com/reference/printf.md) to wrap
  the respective messages to a customizable width.
- Added
...
- [`unnest()`](https://mlr3misc.mlr-org.com/reference/unnest.md) now
...
- [`invoke()`](https://mlr3misc.mlr-org.com/reference/invoke.md): New
  arguments `.opts` and `.seed` to temporarily set options or random
  seeds, respectively.
